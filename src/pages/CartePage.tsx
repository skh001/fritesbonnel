...
// 1. DICTIONNAIRE DE COULEURS POUR LES SAUCES
const sauceColors = {
  Tuche: 'bg-orange-400', 
  Mayonnaise: 'bg-amber-100 border border-gray-300', 
  Ketchup: 'bg-red-600',
  'Sauce Burger': 'bg-amber-700', 
  Bernaise: 'bg-green-700', 
  Samouraï: 'bg-red-500', 
  Poivre: 'bg-stone-800', 
  Blanche: 'bg-white border border-gray-400', 
  Chti: 'bg-red-700', 
};
